...
namespace MealPlan.Database.Migrations
{
    ...
    [Migration("20230727170530_AddUserIdToUnprocessedNotifications")]
    partial class AddUserIdToUnprocessedNotifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MealPlan.Models.Identity.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("MealPlan.Models.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MealPlan.Models.MealPlanEntry", b =>
                {
            ...
            modelBuilder.Entity("MealPlan.Models.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MealPlanEntryPerson", b =>
                {
                    ...
                    b.HasKey("MealPlanEntriesDate", "PeopleId");

                    b.HasIndex("PeopleId");

                    b.ToTable("MealPlanEntryPerson");
                });
            ...
            modelBuilder.Entity("MealPlan.Models.MealPlanEntry", b =>
                {
                    b.HasOne("MealPlan.Models.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("MealPlanEntryPerson", b =>
                {
                    b.HasOne("MealPlan.Models.MealPlanEntry", null)
                        .WithMany()
                        .HasForeignKey("MealPlanEntriesDate")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MealPlan.Models.Person", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("MealPlan.Models.Identity.ApplicationRole", null)
                        .WithMany()
